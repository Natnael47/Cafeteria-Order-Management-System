        ...
        <div className="flex justify-between items-center px-4 sm:px-10 py-3 border-b-2 border-black bg-[#F1FAF2] shadow-md">
            ...
            <div className="relative flex items-center gap-2">
                {profile ? (
                    ...
                    >
                        <div className="relative w-12 h-12 flex items-center justify-center rounded-full bg-gray-800 mr-12 text-white font-bold text-lg cursor-pointer">
                        ...
                        {showDropdown && (
                            <div className="absolute right-0 top-12 z-30 bg-white rounded-lg shadow-2xl border border-gray-200 p-5 w-64 flex flex-col gap-4 transition-all duration-300 transform">
