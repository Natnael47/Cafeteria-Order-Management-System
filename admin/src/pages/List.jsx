...
const List = () => {
    ...
    return (
        <div className="flex flex-col m-5 w-full">
            ...
            <div>
                <div className="grid grid-cols-[0.5fr_0.9fr_0.8fr_0.8fr_0.5fr_0.5fr] items-center gap-2 p-3 border border-gray-300 text-sm font-medium bg-gray-200 sm:grid">
                    <b>Image</b>
                    <b>Name</b>
                    <b>Category</b>
                    <b>Price</b>
                ...
                {list.map((item, index) => (
                    <div key={index} className="grid grid-cols-[0.5fr_0.9fr_0.8fr_0.8fr_0.5fr_0.5fr] items-center gap-2 p-3 border border-gray-300 text-sm font-medium bg-gray-100 sm:grid">
