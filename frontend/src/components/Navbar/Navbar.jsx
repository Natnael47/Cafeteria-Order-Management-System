        ...
        <div className="flex justify-between items-center py-5">
            ...
            <div className="flex items-center gap-10 md:gap-8">
                ...
                <div className="flex items-center gap-[30px]">
                    ...
                    <div className={getTotalCartAmount() === 0 ? "hidden" : "w-4 h-4 flex justify-center items-center -mt-[35px] -ml-[35px] rounded-[11px] text-[10px] bg-red-500 text-white"}>{getCartItems()}</div>
                </div>
